...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 column">
            ...
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/news/toAddNews">新增新闻</a>
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/news/allNews">显示全部新闻</a>
        </div>
        <div class="col-md-4 column"></div>
        <div class="col-md-8 column">
            <form action="${pageContext.request.contextPath}/news/queryNews" method="post" class="form-inline" style="float:right">
        ...
        <div class="col-md-12 column">
            <table class="table table-hover table-striped">
                ...
                <c:forEach var="news" items="${requestScope.get('list')}">
                    <tr>
                        <td>${news.getId()}</td>
                        <td><a href="${pageContext.request.contextPath}/news/toContentNews?id=${news.getId()}">${news.getHead()}</a></td>
                        <td>${news.getBody()}</td>
                        <td>${news.getDate()}</td>
                        <td>${news.getSummary()}</td>
                        <td>${news.getAuthor()}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/news/toUpdateNews?id=${news.getId()}">修改</a>
                            &nbsp | &nbsp
                            <a href="${pageContext.request.contextPath}/news/deleteNews?id=${news.getId()}">删除</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
