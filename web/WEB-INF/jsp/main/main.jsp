...
<head>
    ...
    <link rel="icon" href="${applicationScope.baseUrl}/static/ui/layuimini/images/favicon.ico">
    <link rel="stylesheet" href="${applicationScope.baseUrl}/static/ui/layuimini/lib/layui-v2.6.3/css/layui.css" media="all">
    <link rel="stylesheet" href="${applicationScope.baseUrl}/static/ui/layuimini/css/layuimini.css?v=2.0.4.2" media="all">
    <link rel="stylesheet" href="${applicationScope.baseUrl}/static/ui/layuimini/css/themes/default.css" media="all">
    <link rel="stylesheet" href="${applicationScope.baseUrl}/static/ui/layuimini/lib/font-awesome-4.7.0/css/font-awesome.min.css" media="all">
...
<script src="${applicationScope.baseUrl}/static/ui/layuimini/js/lay-config.js?v=2.0.0" charset="utf-8"></script>
<script>
    layui.use(['jquery', 'layer', 'miniAdmin'], function () {
        ...
        $('.login-out').on("click", function () {
            $.get('${applicationScope.baseUrl}/logout', function (res) {
                if (res.code === 200) {
                    layer.msg(res.data, { time: 500 }, function () {
                        window.location = '${applicationScope.baseUrl}/page/toLogin';
                    })
                } else {
                    layer.msg(res.msg)
                }
